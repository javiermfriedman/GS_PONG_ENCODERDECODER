...
class ConvAutoencoder2(torch.nn.Module):
    ...
    Uses a 64-dimensional latent vector bottleneck.
    """
    def __init__(self):
        ...
        # Bottleneck: flatten and compress to 64-dim latent vector
        self.fc1 = torch.nn.Linear(16 * 10 * 10, 64)  # 64-dim latent vector
        self.fc2 = torch.nn.Linear(64, 16 * 10 * 10)  # Expand back
    ...
    def forward(self, x):
        ...
        x = self.fc1(x)                # Bottleneck (64-dim)
        x = self.fc2(x)                # Expand
