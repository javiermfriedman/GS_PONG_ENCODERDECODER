...
from model_5 import ConvAutoencoder2
...
def main():
    ...
    plt.tight_layout()
    plt.savefig("/Users/javierfriedman/Desktop/Research/EncoderDecoder_pong_greyscale/model_5/reconstruction_results2.png")
    # plt.show()
